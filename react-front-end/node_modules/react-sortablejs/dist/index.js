...
var ReactSortable = /** @class */ (function (_super) {
    ...
    ReactSortable.prototype.componentDidMount = function () {
        ...
        Sortable__default['default'].create(this.ref.current, newOptions);
    };
    ...
    ReactSortable.prototype.onRemove = function (evt) {
        ...
        // @todo -
            ...
            switch (mode) {
                ...
                case "swap":
                default: {
                    invariant__default['default'](true, "mode \"" + mode + "\" cannot clone. Please remove \"props.clone\" from <ReactSortable/> when using the \"" + mode + "\" plugin");
                }
            }
